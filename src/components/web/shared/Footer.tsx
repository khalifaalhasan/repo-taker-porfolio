      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-border/50 pt-8 flex items-center justify-center">
          <p className="text-sm text-muted-foreground text-center">
            &copy; {new Date().getFullYear()} {name}. All rights reserved. <span className="hidden md:inline">|</span><br className="md:hidden" /> Generated by <a href="https://repofolio.web.id" target="_blank" rel="noopener noreferrer" className="hover:text-foreground hover:underline transition-colors font-medium">repofolio.web.id</a>
          </p>
        </div>
      </div>
    </footer>
